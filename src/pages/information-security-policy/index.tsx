        ...
        <div className="bg-slate-50 pt-10 pb-24 md:pt-16 md:pb-36">
          <article className="mx-6 px-6 pt-6 pb-24 max-w-6xl xl:mx-auto lg:px-32 md:pt-16 md:pb-36 bg-white">
            ...
            <section className="pt-6 md:pt-12">
              ...
              <h3 className="pt-7 pb-3 text-lg font-bold">1.経営者の責任</h3>
              <p className="text-sm leading-6 text-gray-700">
                当社は、経営者主導で組織的かつ継続的に情報セキュリティの改善・向上に努めます。
              </p>
              <h3 className="pt-7 pb-3 text-lg font-bold">2.社内体制の整備</h3>
              <p className="text-sm leading-6 text-gray-700">
                当社は、情報セキュリティの維持及び改善のために組織を設置し、情報セキュリティ対策を社内の正式な規則として定めます。
              </p>
              <h3 className="pt-7 pb-3 text-lg font-bold">3.従業員の取組み</h3>
              <p className="text-sm leading-6 text-gray-700">
                当社の従業員は、情報セキュリティのために必要とされる知識、技術を習得し、情報セキュリティへの取り組みを確かなものにします。
              </p>
              <h3 className="pt-7 pb-3 text-lg font-bold">
                4.法令及び契約上の要求事項の遵守
              </h3>
              <p className="text-sm leading-6 text-gray-700">
