  ...
  return (
    <section className="my-28 text-gray-600">
      ...
      <div className="flex flex-col justify-center max-w-4xl mx-auto px-4">
        <div className="flex justify-center items-center flex-col md:flex-row gap-2 w-4/5 md:w-full m-auto">
        ...
        <div className="flex justify-end text-sm font-bold w-4/5 md:w-full mx-auto mt-4">
          <p>※選考は全てWebで実施します</p>
        </div>
      </div>
