  ...
  return (
    <div className="flex flex-col items-center gap-6 md:gap-10">
      ...
      <div className="flex items-center gap-10 max-w-5xl">
        <div className="bg-[#263238] w-[400px] h-60 rounded-lg shrink-0 flex items-center justify-center">
          <Image
            src={AWSMarketpalce}
            alt="AWS Marketplace"
            className="w-[321px] h-[57px]"
          />
        </div>
        <div className="flex flex-col gap-6">
          <p>
            AWS Marketplace
            は、AWSパートナーが提供するソリューションを検索、購入、デプロイ、管理するのに役立つ、ソフトウェアのオンラインストアです。AWS
            で請求と管理を一元化することができます。
          </p>
          <p>
...
const Recommended = () => {
  return (
    <section className="flex flex-col items-center gap-6 md:gap-10">
      ...
      <div className="flex max-w-5xl gap-4 md:gap-10">
        <div className="flex-1 bg-white flex flex-col items-center justify-between gap-6 p-6">
          <Image src={MonitoringIcon} alt="" className="w-[120px] h-[120px]" />
          <p className="text-center">
            AWS Marketplace への SaaS 製品を掲載してビジネス拡大を図りたい方
          </p>
        </div>
        <div className="flex-1 bg-white flex flex-col items-center justify-between gap-6 p-6">
          <Image src={PsychologyIcon} alt="" className="w-[120px] h-[120px]" />
          <p className="text-center">
        ...
        <div className="flex-1 bg-white flex flex-col items-center justify-between gap-6 p-6">
          <Image src={PersonOffIcon} alt="" className="w-[120px] h-[120px]" />
          <p className="text-center">
      ...
      <div className="flex flex-col gap-10 max-w-5xl">
        ...
        <div className="flex flex-col gap-6 items-center justify-center">
          <h4 className="font-bold text-2xl">
            インテグレーションの実装が必要な主な事柄
          </h4>
          <div className="flex gap-10 items-center justify-center">
            <div className="bg-white flex flex-col items-center justify-center gap-6 p-6">
              <div className="text-[#0277BD] font-bold text-xl leading-8 text-center">
                SaaS の「テナント管理や
                <br />
                オンボーディング/オフボーディング処理」
              </div>
...
const Problems = () => {
  return (
    <section className="flex flex-col items-center gap-6 md:gap-10">
      <h3 className="text-2xl md:text-[34px] md:leading-tight text-[#0277BD] font-bold">
        SaaS 製品を掲載したい企業において発生する課題
      </h3>
      <div className="flex gap-10 max-w-5xl">
        <div className="flex-1">
          <div className="md:text-2xl text-white font-bold bg-[#263238] p-4 md:p-6 rounded-t-lg text-center">
            リソースの問題
          </div>
          <p className="text-sm md:text-base text-[#263238] bg-white p-4 md:p-6 rounded-b-lg">
...
const AboutAWSMarketplace = () => {
  return (
    <section className="flex flex-col items-center justify-center gap-20 py-10 md:py-20 bg-[#ECEFF1] tracking-[0.15px]">
      <About />
      <Recommended />
      <Consideration />
      <Problems />
