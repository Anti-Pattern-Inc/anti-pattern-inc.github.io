...
const Strength = () => {
  return (
    <section className="py-10 md:py-20 bg-[#ECEFF1] flex flex-col items-center justify-center">
      <ul className="flex flex-col items-center justify-center gap-6 md:gap-10 max-w-5xl mx-4">
        <li className="flex gap-10">
          ...
          <div className="flex flex-col gap-2 md:gap-6">
            <div className="font-bold text-2xl text-[#0277BD] break-keep">
              独自開発されたヒアリングシート / 結果報告書 / アーキテクチャ図
            </div>
            <p className="text-xl leading-8 text-[#263238] tracking-[0.15px]">
        ...
        <li className="flex gap-10">
          ...
          <div className="flex flex-col gap-2 md:gap-6">
            <div className="font-bold text-2xl text-[#0277BD] break-keep">
              自社製品の掲載実績 (SaaSus Platform)
            </div>
            <p className="text-xl leading-8 text-[#263238] tracking-[0.15px]">
              自社SaaS製品の掲載を実施済み。実装だけでなく事務的な手続きについても把握しドキュメント化済み。
            </p>
            <div className="text-xl leading-8 text-[#263238] tracking-[0.15px]">
